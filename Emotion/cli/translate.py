...
class TranslationTask:
    ...
    def _translate_base(self, base_name: str):
        ...
        for part, fname in data_config['partitions'].items():
            current_partition_path = os.path.join(data_config['base_path'],
                                                  fname)
            ...
            # Write translations in another column and
            # resave source partition .csv-file
...
def main(args):
    ...
    parser.add_argument('config', default='configs/tasks/nmt.yaml',
                        type=str)
    parser.add_argument('--kind', default='en_ru',
                        type=str, choices=['en_ru', 'ru_en'])
